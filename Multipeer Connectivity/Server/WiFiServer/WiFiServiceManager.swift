...
class WiFiServiceManager : NSObject {
    ...
    private let WiFiServiceType = "test-wifi"
    ...
    override init() {
        self.serviceAdvertiser = MCNearbyServiceAdvertiser(peer: myPeerId, discoveryInfo: nil, serviceType: WiFiServiceType)
        self.serviceBrowser = MCNearbyServiceBrowser(peer: myPeerId, serviceType: WiFiServiceType)
